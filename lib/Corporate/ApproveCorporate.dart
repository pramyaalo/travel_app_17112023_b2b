...
class _BookingCardGeneralDetailsState extends State<ApproveCorporate> {
  Future<List<ApproveCorporateModel>?> getFlightTicketOrderQueue() async {
    String SubAgencyId = '';
    List<ApproveCorporateModel> bookingCardData = [];
    Future<http.Response>? __futureLabels = ResponseHandler.performPost(
        "ApproveCorporateGet", "UserTypeId=2&UserId=1107&CorporateId=0");
    ...
    return await __futureLabels?.then((value) async {
      ...
      try {
        ...
        for (int i = 0; i < list.length; i++) {
          ApproveCorporateModel lm = ApproveCorporateModel.fromJson(list[i]);
  ...
  Widget build(BuildContext context) {
    return SafeArea(
        child: Scaffold(
            ...
            body: Center(
              child: FutureBuilder<List<ApproveCorporateModel>?>(
