...
class EarningTypeList extends StatefulWidget {
  const EarningTypeList({Key? key}) : super(key: key);

  @override
  _BookingReportState createState() => _BookingReportState();
}

class _BookingReportState extends State<EarningTypeList> {
  static Future<List<EarningTypeListModel>?> getLabels() async {
    List<EarningTypeListModel> labelData = [];
    Future<http.Response>? __futureLabels =
        ResponseHandler.performPost("StaffEarningTypeGET", "AgentId=1107");
    ...
    return await __futureLabels?.then((value) {
      ...
      try {
        ...
        for (int i = 0; i < list.length; i++) {
          EarningTypeListModel lm = EarningTypeListModel.fromJson(list[i]);
          labelData.add(lm);
        }
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
        ...
        child: const Icon(Icons.add),
            ...
            body: Center(
                child: FutureBuilder<List<EarningTypeListModel>?>(
                    future: getLabels(),
