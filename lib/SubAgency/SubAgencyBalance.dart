...
class SubAgencyBalance extends StatefulWidget {
  const SubAgencyBalance({Key? key}) : super(key: key);

  @override
  State<SubAgencyBalance> createState() => _BookingCardGeneralDetailsState();
}

class _BookingCardGeneralDetailsState extends State<SubAgencyBalance> {
