...
class ManageSubAgency extends StatefulWidget {
  const ManageSubAgency({Key? key}) : super(key: key);

  @override
  State<ManageSubAgency> createState() => _BookingCardGeneralDetailsState();
}

class _BookingCardGeneralDetailsState extends State<ManageSubAgency> {
  Future<List<ManageSubAgencyModel>?> getFlightTicketOrderQueue() async {
    String SubAgencyId = '';
    List<ManageSubAgencyModel> bookingCardData = [];
    Future<http.Response>? __futureLabels = ResponseHandler.performPost(
        "SubAgencyList", "SubAgentId=0&Status=&UserId=1107");
    ...
    return await __futureLabels?.then((value) async {
      ...
      try {
        ...
        for (int i = 0; i < list.length; i++) {
          ManageSubAgencyModel lm = ManageSubAgencyModel.fromJson(list[i]);
  ...
  Widget build(BuildContext context) {
    return SafeArea(
        child: Scaffold(
            ...
            body: Center(
              child: FutureBuilder<List<ManageSubAgencyModel>?>(
