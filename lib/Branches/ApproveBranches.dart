...
class ApproveBranches extends StatefulWidget {
  const ApproveBranches({Key? key}) : super(key: key);

  @override
  State<ApproveBranches> createState() => _BookingCardGeneralDetailsState();
}

class _BookingCardGeneralDetailsState extends State<ApproveBranches> {
