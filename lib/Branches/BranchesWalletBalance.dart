...
class BranchesWalletBalance extends StatefulWidget {
  const BranchesWalletBalance({Key? key}) : super(key: key);

  @override
  State<BranchesWalletBalance> createState() =>
      _BookingCardGeneralDetailsState();
}

class _BookingCardGeneralDetailsState extends State<BranchesWalletBalance> {
