...
class BranchLowBalance extends StatefulWidget {
  const BranchLowBalance({Key? key}) : super(key: key);

  @override
  State<BranchLowBalance> createState() => _BookingCardGeneralDetailsState();
}

class _BookingCardGeneralDetailsState extends State<BranchLowBalance> {
