...
class BranchBalance extends StatefulWidget {
  const BranchBalance({Key? key}) : super(key: key);

  @override
  State<BranchBalance> createState() => _BookingCardGeneralDetailsState();
}

class _BookingCardGeneralDetailsState extends State<BranchBalance> {
